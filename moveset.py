...
class Moveset:
    def __init__(self, moves, move_distance: int = -1, first_move_boost: int = -1, can_move_empty: bool = True, can_capture: bool = True, condition_requirement: str = 'lambda board, tile, team, teams: True', condition_override: str = None):
        self.moves = moves
    ...
    def add_condition(self, condition: Callable[[StandardBoard, str, str, List[Any]], bool], moveset: 'Moveset'):
        if self.condition_override == None:
